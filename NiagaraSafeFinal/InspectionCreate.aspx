<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectionCreate.aspx.cs" Inherits="SafetyAuth.InspectionCreate" %>
...
<html lang="en">
  <head>
    ...
    <title>Niagara Safety | Inspection Create</title>
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <div class="row">
                        <div class="col-md-3">
                            <h2>Area: <asp:DropDownList ID="ddlArea1" runat="server" CssClass="form-control"></asp:DropDownList></h2>
                        </div>
                        <div class="col-md-3">
                            <h2>Other: <asp:TextBox ID="txtArea1" runat="server" CssClass="form-control"></asp:TextBox></h2>
                        </div>
                    </div>
                    <ul class="nav navbar-right panel_toolbox">
                    </ul>
                  ...
                  <div class="x_content">
                        <div class="row">
                            <div class="col-lg-2">
                                 Hazard: <asp:DropDownList ID="ddHazard1" runat="server" CssClass="form-control"></asp:DropDownList>
                            </div>
                            <div class="col-lg-2">
                                Hazard Other: <asp:TextBox ID="txtHazardOther1" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-lg-3">
                                Hazard Description: <asp:TextBox ID="txtHazardDesc1" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-lg-3">
                                Corrective Action Description: <asp:TextBox ID="txtActionDesc1" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-lg-2">
                                Corrective Action Due Date: 
                                <br />
                                <asp:Calendar ID="calDueDate1" runat="server"></asp:Calendar>
                            </div>
                        </div>
                  </div>
                </div>
            ...
            <asp:Button ID="btnCreateArea" runat="server" Text="Create Area" CssClass="btn btn-primary btn-block" OnClick="btnCreateArea_Click" />
