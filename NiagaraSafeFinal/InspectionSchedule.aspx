<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectionSchedule.aspx.cs" Inherits="SafetyAuth.InspectionSchedule" %>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      Simply select a desired lab, technician, and due date for the inspection and press submit.  The bottom box shows the most recently
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <br />
                      <div class="row">
                          <asp:Button ID="btnSchedule" runat="server" Text="Schedule" CssClass="btn btn-primary btn-block" OnClick="btnSchedule_Click" />
                      </div>
                  </div>
                </div>
              </div>
