<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectionAssigned.aspx.cs" Inherits="SafetyAuth.InspectionAssigned" %>
...
<html lang="en">
  <head>
    ...
    <title>Niagara Safety | Assigned Inspections</title>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      This page displays Inspections which are assigned to a technician.
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content" runat="server">
                    <table id="datatable1" class="table table-striped table-bordered">
                      ...
                      <tbody id="pendingResults" runat="server">
                      </tbody>
                    </table>
                  </div>
                </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content" runat="server">
                   <table id="datatable2" class="table table-striped table-bordered">
                      ...
                      <tbody id="startedResults" runat="server">
                      </tbody>
                    </table>
                  </div>
                </div>
...
<%--            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content" id="completeResults" runat="server">
                  </div>
                </div>
              </div>
            </div>--%>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <table id="datatable3" class="table table-striped table-bordered">
                      ...
                      <tbody id="completeResults" runat="server">
                      </tbody>
                    </table>
                  </div>
                </div>
