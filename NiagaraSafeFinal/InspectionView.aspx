<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectionView.aspx.cs" Inherits="SafetyAuth.InspectionView" %>
...
<html lang="en">
  <head>
    ...
    <title>Niagara Safety | Inspection View</title>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <asp:Button ID="btnEditActions" runat="server" OnClick="btnEditActions_Click" CssClass="btn btn-block btn-primary" Text="Edit Corrective Actions"/>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      <asp:Button ID="btnEdit" runat="server" Text="Edit Inspection" CssClass="btn btn-primary btn-block" OnClick="btnEdit_Click" />
                      <asp:Button ID="btnDelete" runat="server" Text="Delete Inspection" CssClass="btn btn-danger btn-block" OnClick="btnDelete_Click" />
                  </div>
                </div>
              </div>
            </div>
