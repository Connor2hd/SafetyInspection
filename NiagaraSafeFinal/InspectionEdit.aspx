<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectionEdit.aspx.cs" Inherits="SafetyAuth.InspectionEdit" %>
...
<html lang="en">
  <head>
    ...
    <title>Niagara Safety | Inspection Edit</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Inspection #<asp:Label ID="lblBigInspectionID" runat="server" Text="Label"></asp:Label></h3>
              </div>
            </div>
            <div class="clearfix"></div>
            <form runat="server">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      <div class="row">
                          <div class="col-md-4">
                            Inspection ID: <asp:TextBox ID="txtInspectionID" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                          </div>
                          <div class="col-md-4">
                      ...
                      <div class="row">
                          <div class="col-md-4">
                              Inspction Status: <asp:DropDownList ID="ddlInspectionStatus" CssClass="form-control" runat="server"></asp:DropDownList>
                          </div>
                          <div class="col-md-4">
...
<%--                              Room Name: <asp:Label ID="lblRoomName" runat="server" Text="Label"></asp:Label>--%>
                      ...
                      <div class="row">
                          <div class="col-md-2">
                              Date Assigned: <br />
                              <asp:Calendar ID="calDateAssigned" runat="server"></asp:Calendar>
                          </div>
                          <div class="col-md-2">
                              Date Tech Can Start: <br />
                              <asp:Calendar ID="calDateCanStart" runat="server"></asp:Calendar>
                          </div>
                          <div class="col-md-2">
                              Due Date: <br />
                          ...
                          <div class="col-md-2">
                              Finish Date: <br />
                              <asp:Calendar ID="calFinishDate" runat="server"></asp:Calendar>
                          </div>
                      </div>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      <asp:Button ID="btnSave" runat="server" Text="Save Inspection" CssClass="btn btn-primary btn-block" OnClick="btnSave_Click" />
