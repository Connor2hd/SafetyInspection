<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorrectiveActions.aspx.cs" Inherits="SafetyAuth.CorrectiveActions" %>
...
<html lang="en">
  <head>
    ...
    <title>Niagara Safety | Corrective Actions</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Corrective Action Search</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      Use this form to locate an incomplete or completed corrective action.  Leave all fields blank and press search to view all corrective actions.
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <div class="row">
                          <div class="col-md-2">
                              Inspection ID: <br />
                              <asp:TextBox ID="txtInspectionID" runat="server" CssClass="form-control"></asp:TextBox> <br />
                              Corrective Action ID: <br />
                              <asp:TextBox ID="txtCorrectiveActionID" runat="server" CssClass="form-control"></asp:TextBox>
                          </div>
                          <div class="col-md-2">
                              Lab/Room: <br />
                              <asp:DropDownList ID="ddlLab" runat="server" CssClass="form-control"></asp:DropDownList>
                          </div>
                          <div class="col-md-2">
                              Status: <br />
                          ...
                          <div class="col-md-2">
                              Technician: <br />
                              <asp:DropDownList ID="ddlTechnician" runat="server" CssClass="form-control"></asp:DropDownList>
                          </div>
                          <div class="col-md-2">
                              Due Date:<br />
