<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DatabaseAdminLab.aspx.cs" Inherits="SafetyAuth.DatabaseAdminLab" %>
...
<html lang="en">
  <head>
    ...
    <title>Niagara Safety | Lab/Room Management</title>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      Use this form to edit the room selected on the previous page.  Press submit to save the record and cancel to return to the previous page.
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="row">
                        Lab/Room ID:
                        <asp:TextBox ID="txtLabID" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                    </div>
                    <div class="row">
                        Lab Name: 
