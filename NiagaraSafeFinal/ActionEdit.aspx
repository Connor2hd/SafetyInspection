              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      <div class="row">
                          <div class="col-md-4">
                            <asp:RangeValidator ID="valInspectionID" runat="server" ErrorMessage="Please Enter a Whole Number" ControlToValidate="txtInspectionID" MaximumValue="9999999" MinimumValue="1"></asp:RangeValidator>
